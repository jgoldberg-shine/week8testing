...
#REPLACE LOWERCASE VALUES WITH UPPERCASE
df["Payment Method"] = df["Payment Method"].replace({"debit": "Debit", "credit": "Credit", "cash": "Cash", "voucher": "Voucher"})
...
#outlier in spreadsheets adjusted from 700 to 7
